...
// Begin Cloverly 2017 Layout. 
  ...
  void Cloverly2017() {
    ...
    Track town = new Track(sidings.rightEntry.straight, 1, 180*11);
    Track ts1 = new Track(town, 1, 360, -30);
    Track ts2 = new Track(ts1, 1, 360, 30);
    Track ts3 = new Track(ts2, 1, 360, -30);
    Track ts4 = new Track(ts3, 1, 360, 30);
    Track ts5 = new Track(ts4, 1, 360, -30*3);
    Turnout msRight = new5117R(ts5, 15, null);
    
    Track frontTunnel = new Track(station.innerRight.straight, 1, (180*4) + 70 + 22);
    Track ft1 = new Track(frontTunnel, 1, 360, -30);
    Track ft2 = new Track(ft1, 1, 180);
    Turnout msLeft = new5117L(ft2, 14, null);
    Track ft3 = new Track(msLeft.divergent, 1, 360, 30*2);
    
    MountainSidings ms = new MountainSidings(msLeft, msRight);
  ...
  class MountainSidings {
    ...
    MountainSidings(Turnout frontPoint, Turnout rearPoint) {
      toBack = new Track(rearPoint.straight, 1, (180*2) + 90);
      tfC1 = new Track(frontPoint.straight, 1, 360, 7.5);
